...
const PIXEL_OPERATOR_8 = preload("uid://d2jfgwkyvxibg")

func displayDamage_Number(value:int ,position: Vector2,is_critical:bool = false ):
	...
	number.label_settings.font = PIXEL_OPERATOR_8
